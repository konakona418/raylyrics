...
elseif ("${PLATFORM}" STREQUAL "Wayland")
    # Native Wayland backend using wlr-layer-shell + EGL (no GLFW, no X11)
    set(PLATFORM_CPP "PLATFORM_WAYLAND_LAYER")
    # Slug text rendering requires GLSL 430 + SSBOs
    ...
    include_directories(${WAYLAND_CLIENT_INCLUDE_DIRS} ${WAYLAND_EGL_INCLUDE_DIRS} ${EGL_INCLUDE_DIRS})
    set(LIBS_PRIVATE pthread ${OPENGL_LIBRARIES} ${WAYLAND_CLIENT_LIBRARIES} ${WAYLAND_EGL_LIBRARIES} ${EGL_LIBRARIES})
    set(LIBS_PUBLIC m)
endif ()
